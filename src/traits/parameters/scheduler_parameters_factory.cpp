...
namespace traits
{
            ...
            : AlgorithmParametersFactoryBase(constants::k_scheduler_parameters)
    {
        ...
        setParent(constants::k_traits_milp_scheduler_parameters, constants::k_milp_scheduler_parameters);
        ...
        setRequired(constants::k_traits_milp_scheduler_parameters, {});
        ...
        setOptional(constants::k_traits_milp_scheduler_parameters,
                    {{constants::k_use_hierarchical_objective, nlohmann::json::value_t::boolean}});
        ...
        setDefault(constants::k_traits_milp_scheduler_parameters,
                   {{constants::k_use_hierarchical_objective, false}});
