...
namespace traits
{
    TraitsPgmOmplEnvironment::TraitsPgmOmplEnvironment()
            : TraitsOmplEnvironment{OmplEnvironmentType::e_pgm, OmplStateSpaceType::e_se2}
    {
        m_state_space = std::make_shared<ompl::base::SE2StateSpace>();
    }

    TraitsPgmOmplEnvironment::TraitsPgmOmplEnvironment(const std::string& filepath,
    ...
    bool TraitsPgmOmplEnvironment::isValid(const ompl::base::State* state) const
    {
    ...
    float TraitsPgmOmplEnvironment::longestPath() const
    {
        // Perimeter of map
