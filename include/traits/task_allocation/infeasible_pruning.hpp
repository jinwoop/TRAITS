...
namespace traits
{
     ...
     */
    class TraitsInfeasiblePruning : public PruningMethodBase<TraitsIncrementalTaskAllocationNode>
    {
       public:
        //! Constructor
        explicit TraitsInfeasiblePruning(const std::shared_ptr<const TraitsProblemInputs>& problem_inputs);
