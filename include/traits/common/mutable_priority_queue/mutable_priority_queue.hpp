...
// Local
#include "traits/common/mutable_priority_queue/mutable_priority_queue_comparator.hpp"
#include "traits/common/mutable_priority_queue/mutable_priority_queue_node.hpp"
#include "traits/common/mutable_priority_queue/mutable_priority_queueable.hpp"
...
namespace traits
{
    ...
    class MutablePriorityQueue : private Noncopyable
    {
    ...
    public:
        ...
        /*!
         * \brief Adds a new element or updates an old one
         *
        ...
        /*!
         * \brief Removes an element if it is in the heap
         *
        ...
        void erase(const KeyType& key)
        {
            ...
            {
                throw createLogicError(fmt::format("There is no element with key {0}", key));
            }
        }
        ...
        /*!
         * \brief Returns the top element from the priority queue and removes it from the queue
         *
