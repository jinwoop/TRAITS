...
// Local
#include "traits/common/search/a_star/a_star_functors.hpp"
#include "traits/common/search/a_star/a_star_search_node_base.hpp"
#include "traits/common/search/best_first_search_base.hpp"
#include "traits/common/search/path_cost_base.hpp"

namespace traits
{
    /*!
     * \brief Conducts a generic A* search to find the shortest path if given an admissible heuristic
     *
