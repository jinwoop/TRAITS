...
{
    /*!
     * \brief Base class for a search node for an A* search
     *
    ...
    {
        using Base_ = GreedyBestFirstSearchNodeBase<AStarSearchNodeDeriv>;

    public:
        //! \brief Sets the path cost for a node
