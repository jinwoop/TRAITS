...
namespace traits
{
    ...
    {
    public:
        virtual ~SearchNodeBase() = default;
        ...
        //! \returns A json representation of this search node
        [[nodiscard]] virtual nlohmann::json serializeToJson(
                const std::shared_ptr<const ProblemInputs>& problem_inputs) const = 0;
