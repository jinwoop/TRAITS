...
#include "traits/common/search/undirected_graph/undirected_graph_edge_applier.hpp"

namespace traits
{
    /*!
     * \brief Generates the successors for a node based upon a finite undirected graph
     *
    ...
    {
        using Base_ = SuccessorGeneratorBase<UndirectedGraphSearchNodeDeriv>;
    ...
    public:
                ...
                const std::shared_ptr<typename UndirectedGraphSearchNodeDeriv::Graph>& graph)
        {
            ...
            {
                Base_::m_edge_appliers.push_back(
