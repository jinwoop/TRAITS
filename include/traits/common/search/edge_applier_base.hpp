...
{
    /*!
     *  \brief An interface for defining how to check whether an edge can be applied to a node and defining how to apply
    ...
    concept EdgeApplierDeriv = std::derived_from<T, EdgeApplierBase<SearchNode>>;
}  // namespace traits
