...
// Local
#include "traits/common/utilities/custom_concepts.hpp"
...
namespace traits
{
    ...
    using TraitsCoalitionView = ::ranges::transform_view<
    ...
    using TraitsPlanView = ::ranges::transform_view<::ranges::ref_view<const std::vector<unsigned int>>,
