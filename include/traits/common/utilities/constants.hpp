...
namespace traits::constants
{
    ...
    CREATE_JSON_KEY(absolute_deadline)
    CREATE_JSON_KEY(battery_current_function_power)
    CREATE_JSON_KEY(bounding_radius)
    CREATE_JSON_KEY(bound)
    CREATE_JSON_KEY(bound_type)
    CREATE_JSON_KEY(bounds)
    CREATE_JSON_KEY(coalition)
    CREATE_JSON_KEY(completion)
    ...
    CREATE_JSON_KEY(current_trait_functions_coeff)
    CREATE_JSON_KEY(current_trait_functions_power)
    CREATE_JSON_KEY(current_trait_rate_functions_coeff)
    CREATE_JSON_KEY(current_trait_rate_functions_power)
    CREATE_JSON_KEY(deadline_type)
    CREATE_JSON_KEY(deadlines)
    CREATE_JSON_KEY(deadline_constraints)
    CREATE_JSON_KEY(delta)
    CREATE_JSON_KEY(delta_percentage)
    CREATE_JSON_KEY(desired_traits)
    CREATE_JSON_KEY(desired_traits_mean)
    CREATE_JSON_KEY(desired_traits_variance)
    ...
    CREATE_JSON_KEY(initial_trait_levels)
    CREATE_JSON_KEY(initial_battery_level)
    CREATE_JSON_KEY(is_complete)
    CREATE_JSON_KEY(itags_parameters)
    CREATE_JSON_KEY(itags_stochastic_parameters)
    CREATE_JSON_KEY(last_edge)
    CREATE_JSON_KEY(low)
    CREATE_JSON_KEY(low_level_timer_name)
    CREATE_JSON_KEY(makespan)
    CREATE_JSON_KEY(masked)
    CREATE_JSON_KEY(max_sample_size)
    CREATE_JSON_KEY(max_battery_capacity)
    CREATE_JSON_KEY(max_possible_current)
    CREATE_JSON_KEY(max_speed)
    CREATE_JSON_KEY(method)
    CREATE_JSON_KEY(milp_scheduler_type)
    CREATE_JSON_KEY(milp_timeout)
    CREATE_JSON_KEY(mip_gap)
    CREATE_JSON_KEY(minimum_trait_rates)
    ...
    CREATE_JSON_KEY(objective_ratio_name)
    ...
    CREATE_JSON_KEY(relative_deadline)
    ...
    CREATE_JSON_KEY(speed_coeff)
    CREATE_JSON_KEY(static_duration)
    CREATE_JSON_KEY(start)
    ...
    CREATE_JSON_KEY(successor)
    CREATE_JSON_KEY(target_task_name)
    CREATE_JSON_KEY(target_relative_deadline)
    CREATE_JSON_KEY(task)
    CREATE_JSON_KEY(tasks)
    CREATE_JSON_KEY(task_allocation_time)
    CREATE_JSON_KEY(task_associations)
    CREATE_JSON_KEY(task_distribution_time)
    CREATE_JSON_KEY(task_planning_time)
    CREATE_JSON_KEY(task_apr_status)
    CREATE_JSON_KEY(task_completion_status)
    CREATE_JSON_KEY(terminal_configuration)
    CREATE_JSON_KEY(threads)
    CREATE_JSON_KEY(threshold)
    CREATE_JSON_KEY(time)
    CREATE_JSON_KEY(timepoint)
    CREATE_JSON_KEY(timepoint_type)
    CREATE_JSON_KEY(timeout)
    CREATE_JSON_KEY(timer_name)
    CREATE_JSON_KEY(total_time)
    CREATE_JSON_KEY(traits)
    CREATE_JSON_KEY(trait_allocations)
    CREATE_JSON_KEY(trait_distribution_parameters)
    CREATE_JSON_KEY(traits_max)
    CREATE_JSON_KEY(trait_rates_max)
    CREATE_JSON_KEY(traits_mean)
    CREATE_JSON_KEY(traits_variance)
    CREATE_JSON_KEY(traits_aggregatable)
    CREATE_JSON_KEY(traits_provisionable)
    CREATE_JSON_KEY(traits_exhaustible)
    CREATE_JSON_KEY(traits_parameters)
    CREATE_JSON_KEY(transitions)
    CREATE_JSON_KEY(turning_radius)
    CREATE_JSON_KEY(ub_lb_calculation_time)
    CREATE_JSON_KEY(use_data_dir)
    CREATE_JSON_KEY(use_hierarchical_objective)
    CREATE_JSON_KEY(use_sprt)
    CREATE_JSON_KEY(value)
    ...
    constexpr std::string_view k_traits_milp_scheduler_parameters = "TraitsMilpSchedulerParameters";
    constexpr std::string_view k_nlp_parameters = "NlpParameters";
