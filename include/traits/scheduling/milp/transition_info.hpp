...
namespace traits
{
    ...
    class TraitsTransitionInfo
    {
       public:
         ...
         */
        TraitsTransitionInfo(TraitsCoalitionView coalition,
        ...
        void createMutexTransitionConstraintHeuristic(GRBModel& model,
                                                      GRBVar& predecessor,
                                                      GRBVar& successor,
                                                      GRBLinExpr&& mutex_indicator_component);
        ...
        [[nodiscard]] inline float durationUpperBound() const;


    private:
        float m_duration_lowerbound;
        float m_duration_upperbound;
    ...
    // Inline Functions
    float TraitsTransitionInfo::durationLowerBound() const
    {
        return m_duration_lowerbound;
    }

    float TraitsTransitionInfo::durationUpperBound() const
    {
        return m_duration_upperbound;
    }
