...
{
    template <>
    struct adl_serializer<std::shared_ptr<const traits::Se3OmplConfiguration>>
    {
        //! Non-default constructable from_json
        static std::shared_ptr<const traits::Se3OmplConfiguration> from_json(const json& j);
        static void to_json(json& j, const std::shared_ptr<const traits::Se3OmplConfiguration>& c);
    };

    template <>
    struct adl_serializer<std::shared_ptr<traits::Se3OmplConfiguration>>
{
    //! Non-default constructable from_json
    static std::shared_ptr<traits::Se3OmplConfiguration> from_json(const json& j);
    static void to_json(json& j, const std::shared_ptr<traits::Se3OmplConfiguration>& c);
};
}  // namespace nlohmann
