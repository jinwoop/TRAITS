...
{
    template <>
    struct adl_serializer<std::shared_ptr<const traits::Se3StateOmplConfiguration>>
    {
        static std::shared_ptr<const traits::Se3StateOmplConfiguration> from_json(const json& j);
        static void to_json(json& j, const std::shared_ptr<const traits::Se3StateOmplConfiguration>& c);
    };

    template <>
    struct adl_serializer<std::shared_ptr<traits::Se3StateOmplConfiguration>>
{
    static std::shared_ptr<traits::Se3StateOmplConfiguration> from_json(const json& j);
    static void to_json(json& j, const std::shared_ptr<traits::Se3StateOmplConfiguration>& c);
};
}  // namespace nlohmann
