...
{
    template <>
    struct adl_serializer<std::shared_ptr<const traits::Se2StateOmplConfiguration>>
    {
        //! Non-default constructable from_json
        static std::shared_ptr<const traits::Se2StateOmplConfiguration> from_json(const json& j);
        static void to_json(json& j, const std::shared_ptr<const traits::Se2StateOmplConfiguration>& c);
    };

    template <>
    struct adl_serializer<std::shared_ptr<traits::Se2StateOmplConfiguration>>
{
    //! Non-default constructable from_json
    static std::shared_ptr<traits::Se2StateOmplConfiguration> from_json(const json& j);
    static void to_json(json& j, const std::shared_ptr<traits::Se2StateOmplConfiguration>& c);
};
}  // namespace nlohmann
