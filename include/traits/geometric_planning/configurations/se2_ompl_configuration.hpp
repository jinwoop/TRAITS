...
{
    template <>
    struct adl_serializer<std::shared_ptr<const traits::Se2OmplConfiguration>>
    {
        //! Non-default constructable from_json
        static std::shared_ptr<const traits::Se2OmplConfiguration> from_json(const json& j);
        static void to_json(json& j, const std::shared_ptr<const traits::Se2OmplConfiguration>& c);
    };

    template <>
    struct adl_serializer<std::shared_ptr<traits::Se2OmplConfiguration>>
{
    //! Non-default constructable from_json
    static std::shared_ptr<traits::Se2OmplConfiguration> from_json(const json& j);
    static void to_json(json& j, const std::shared_ptr<traits::Se2OmplConfiguration>& c);
};
}  // namespace nlohmann
