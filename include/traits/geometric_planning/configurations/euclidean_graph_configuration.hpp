...
{
    template <>
    struct adl_serializer<std::shared_ptr<const traits::EuclideanGraphConfiguration>>
    {
        //! Non-default constructable from_json
        static std::shared_ptr<const traits::EuclideanGraphConfiguration> from_json(const json& j);
        static void to_json(json& j, const std::shared_ptr<const traits::EuclideanGraphConfiguration>& c);
    };

    template <>
    struct adl_serializer<std::shared_ptr<traits::EuclideanGraphConfiguration>>
{
    //! Non-default constructable from_json
    static std::shared_ptr<traits::EuclideanGraphConfiguration> from_json(const json& j);
    static void to_json(json& j, const std::shared_ptr<traits::EuclideanGraphConfiguration>& c);
};
}  // namespace nlohmann
