...
{
    template <>
    struct adl_serializer<std::shared_ptr<const traits::GraphConfiguration>>
    {
        //! Non-default constructable from_json
        static std::shared_ptr<const traits::GraphConfiguration> from_json(const json& j);
        static void to_json(json& j, const std::shared_ptr<const traits::GraphConfiguration>& c);
    };

    template <>
    struct adl_serializer<std::shared_ptr<traits::GraphConfiguration>>
    {
        //! Non-default constructable from_json
        static std::shared_ptr<traits::GraphConfiguration> from_json(const json& j);
        static void to_json(json& j, const std::shared_ptr<traits::GraphConfiguration>& c);
    };
}  // namespace nlohmann
