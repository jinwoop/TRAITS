...
{
    template <>
    struct adl_serializer<std::shared_ptr<const traits::OmplConfiguration>>
    {
        //! Non-default constructable from_json
        static std::shared_ptr<const traits::OmplConfiguration> from_json(const json& j);
        static void to_json(json& j, const std::shared_ptr<const traits::OmplConfiguration>& c);
    };

    template <>
    struct adl_serializer<std::shared_ptr<traits::OmplConfiguration>>
    {
        //! Non-default constructable from_json
        static std::shared_ptr<traits::OmplConfiguration> from_json(const json& j);
        static void to_json(json& j, const std::shared_ptr<traits::OmplConfiguration>& c);
    };
}  // namespace nlohmann
