...
namespace traits
{
    ...
    public:
        ...
        [[nodiscard]] std::shared_ptr<ParametersBase> create(Type type, const nlohmann::json& j) const;
    ...
    public:
        ...
        TraitDistributionParametersFactory& m_trait_distribution_parameters_factory;
        //  endregion
    };  // class ParametersFactory
}  // namespace traits
