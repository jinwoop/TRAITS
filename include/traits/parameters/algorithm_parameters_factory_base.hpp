...
namespace traits
{
    ...
    public:
        ...
        [[nodiscard]] std::shared_ptr<ParametersBase> create(const nlohmann::json& j) const;

        [[nodiscard]] std::shared_ptr<ParametersBase> create(const nlohmann::json& j, const std::string& config_type) const;
